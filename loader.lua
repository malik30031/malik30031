...
local args = {
    [1] = "RolePlayBio",
    [2] = "・一一仁了二二二二二二二二二二二二二二フ"}
 
game:GetService("ReplicatedStorage").RE:FindFirstChild("1RPNam1eTex1t"):FireServer(unpack(args))
wait(0.5)
game.StarterGui:SetCore("SendNotification", {
    Title = "صُنِعُ أَلْمَطْوٌرٌ مالڪ  ";
...
MakeWindow({
  Hub = {
    Title = "1.V BETA سكربت مالڪ | MALIK SCRIPT",
    Animation = " 🦅 "
  },
  Key = {
    KeySystem = false,
...
local Paragraph = AddParagraph(Main, {"حساباتي سوشل ميديا للتوصل معي", "bom dia meus manos"})
AddButton(Main, {
  Name = "~انـسـخ يـوزري تـيـك تـوك~",
  Callback = function()
    setclipboard('av_fire')
  end
})
...
SetSection(AddSection(Main6, {"Coowner"}), "Owner : malik🦅")
